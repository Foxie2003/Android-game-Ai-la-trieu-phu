...
public class ChallengeGameActivity extends AppCompatActivity {
    ...
    private final String TAG = "ChallengeGameActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = new DB(ChallengeGameActivity.this.getApplicationContext());
        ...
        soundManager = new SoundManager(ChallengeGameActivity.this);
            ...
            public void onClick(View v) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Animation fadeInAnimation = AnimationUtils.loadAnimation(ChallengeGameActivity.this, R.anim.fade_in);
                        layoutPlayMain.startAnimation(fadeInAnimation);
                        //Bắt đầu đọc câu hỏi
                        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                if(!userId.equals(room.turn) || room == null) {
                                    showWaiting("Vui lòng chờ đến lượt của bạn");
                                }
                                else {
...
//                                loadQuestion(question);
    ...
    private void showInterstitialAds() {
        if (mInterstitialAd != null) {
            mInterstitialAd.show(ChallengeGameActivity.this);
        } else {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
            ...
            public void run() {
                if(!playerIsReady) {
                    ...
                    Animation shakeAnimation = AnimationUtils.loadAnimation(ChallengeGameActivity.this, R.anim.shaking);
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                soundManager.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mp) {
                        ...
                        Animation flashingAnimation = AnimationUtils.loadAnimation(ChallengeGameActivity.this, R.anim.flashing);
...
//        btnQuestionNumber.setEnabled(true);
    ...
    public void lifeLineAskAudience() {
        ...
        soundManager.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                Dialog askAudienceDialog = new Dialog(ChallengeGameActivity.this, android.R.style.Theme_DeviceDefault_Dialog_NoActionBar);
                ...
                for (int i = 0; i < 4; i++) {
                    ...
                    Animation animation = AnimationUtils.loadAnimation(ChallengeGameActivity.this, R.anim.growing);
                ...
                Animation fadeInAnimation = AnimationUtils.loadAnimation(ChallengeGameActivity.this, R.anim.growing_light);
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                soundManager.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mp) {
                        ...
                        Dialog callDialog = new Dialog(ChallengeGameActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                soundManager.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mp) {
                        ...
                        Dialog askThreeAudienceDialog = new Dialog(ChallengeGameActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
    ...
    private void showGameOverDialog() {
        ...
        gameoverDialog = new Dialog(ChallengeGameActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (savedFile != null) {
                    Toast.makeText(ChallengeGameActivity.this, "Đã chụp màn hình để chia sẻ", Toast.LENGTH_SHORT).show();
                    try {
...
//                        gameoverDialog.dismiss();
                        List<ResolveInfo> resInfoList = ChallengeGameActivity.this.getPackageManager().queryIntentActivities(intent, PackageManager.MATCH_DEFAULT_ONLY);
                        for (ResolveInfo resolveInfo : resInfoList) {
                            String packageName = resolveInfo.activityInfo.packageName;
                            ChallengeGameActivity.this.grantUriPermission(packageName, uri, Intent.FLAG_GRANT_WRITE_URI_PERMISSION | Intent.FLAG_GRANT_READ_URI_PERMISSION);
                        }
...
//                    gameoverDialog.dismiss();
                    Toast.makeText(ChallengeGameActivity.this, "Failed to save screenshot", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//            showRetryDialog();
    ...
    private void showWinDialog() {
        ...
        Dialog winDialog = new Dialog(ChallengeGameActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
...
//                    winDialog.dismiss();
    ...
    private void showBuyLifeLineDialog(int lifeLineId) {
        ...
        Dialog buyLifeLineDialog = new Dialog(ChallengeGameActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
            ...
            ivBuy.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(database.minusDiamond(finalPrice)) {
                        ...
                        iv5050.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                iv5050.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Toast.makeText(ChallengeGameActivity.this, "Bạn đã hết lượt sử dụng trợ giúp này", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        });
                        ...
                        Toast.makeText(ChallengeGameActivity.this, "KC không đủ", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void showStopDialog() {
        ...
        Dialog stopDialog = new Dialog(ChallengeGameActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
    ...
    public void updateAnswer(String roomId, String userId, boolean isCorrect) {
        ...
        roomRef.runTransaction(new Transaction.Handler() {
            ...
            public Transaction.Result doTransaction(MutableData mutableData) {
                ...
                if ((userId.equals(room.player1Id) && userId.equals(room.turn)) ||
                        (userId.equals(room.player2Id) && userId.equals(room.turn))) {

                    if (isCorrect) {
                        if (userId.equals(room.player1Id)) {
                            room.player1CorrectAnswers++;
                        } else if (userId.equals(room.player2Id)) {
                            room.player2CorrectAnswers++;
                        }
                    }
                    if(room.turn.equals(room.player2Id)) {
                        room.currentQuestionIndex++;
                    }
                    // Chuyển lượt chơi cho người còn lại
                    room.turn = room.turn.equals(room.player1Id) ? room.player2Id : room.player1Id;
                }
    ...
    public void listenToRoomUpdates(String roomId) {
        ...
        valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (room != null && room.status.equals("ongoing")) {
                ...
                else if (room != null && room.status.equals("gameover")) {
                    if(!userId.equals(room.turn)) {
                        showWinDialog();
                    }
                }
                    ...
                    Toast.makeText(ChallengeGameActivity.this, "Room is NULL", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void showWaiting(String message) {
        ...
        //Khởi tạo dialog chờ
        waitingDialog = new Dialog(ChallengeGameActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
