...
public class ChallengeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = new DB(ChallengeActivity.this.getApplicationContext());
        ...
        soundManager = new SoundManager(ChallengeActivity.this);
            ...
            public void onClick(View v) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Animation fadeInAnimation = AnimationUtils.loadAnimation(ChallengeActivity.this, R.anim.fade_in);
...
//                                loadQuestion(question);
    ...
    private void showInterstitialAds() {
        if (mInterstitialAd != null) {
            mInterstitialAd.show(ChallengeActivity.this);
        } else {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
            ...
            public void run() {
                if(!playerIsReady) {
                    ...
                    Animation shakeAnimation = AnimationUtils.loadAnimation(ChallengeActivity.this, R.anim.shaking);
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                soundManager.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mp) {
                        ...
                        Animation flashingAnimation = AnimationUtils.loadAnimation(ChallengeActivity.this, R.anim.flashing);
...
//        btnQuestionNumber.setEnabled(true);
    ...
    public void lifeLineAskAudience() {
        ...
        soundManager.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                Dialog askAudienceDialog = new Dialog(ChallengeActivity.this, android.R.style.Theme_DeviceDefault_Dialog_NoActionBar);
                ...
                for (int i = 0; i < 4; i++) {
                    ...
                    Animation animation = AnimationUtils.loadAnimation(ChallengeActivity.this, R.anim.growing);
                ...
                Animation fadeInAnimation = AnimationUtils.loadAnimation(ChallengeActivity.this, R.anim.growing_light);
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                soundManager.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mp) {
                        ...
                        Dialog callDialog = new Dialog(ChallengeActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                soundManager.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mp) {
                        ...
                        Dialog askThreeAudienceDialog = new Dialog(ChallengeActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
                        ...
                        //Áp dụng animation cho chữ
                        Animation growingLight = AnimationUtils.loadAnimation(ChallengeActivity.this, R.anim.growing_light);
    ...
    private void showGameOverDialog() {
        ...
        gameoverDialog = new Dialog(ChallengeActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (savedFile != null) {
                    Toast.makeText(ChallengeActivity.this, "Đã chụp màn hình để chia sẻ", Toast.LENGTH_SHORT).show();
                    try {
...
//                        gameoverDialog.dismiss();
                        List<ResolveInfo> resInfoList = ChallengeActivity.this.getPackageManager().queryIntentActivities(intent, PackageManager.MATCH_DEFAULT_ONLY);
                        for (ResolveInfo resolveInfo : resInfoList) {
                            String packageName = resolveInfo.activityInfo.packageName;
                            ChallengeActivity.this.grantUriPermission(packageName, uri, Intent.FLAG_GRANT_WRITE_URI_PERMISSION | Intent.FLAG_GRANT_READ_URI_PERMISSION);
                        }
...
//                    gameoverDialog.dismiss();
                    Toast.makeText(ChallengeActivity.this, "Failed to save screenshot", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void showWinDialog() {
        ...
        Dialog winDialog = new Dialog(ChallengeActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
...
//                    winDialog.dismiss();
    ...
    private void showBuyLifeLineDialog(int lifeLineId) {
        ...
        Dialog buyLifeLineDialog = new Dialog(ChallengeActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
            ...
            ivBuy.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(database.minusDiamond(finalPrice)) {
                        ...
                        iv5050.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                iv5050.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Toast.makeText(ChallengeActivity.this, "Bạn đã hết lượt sử dụng trợ giúp này", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        });
                        ...
                        Toast.makeText(ChallengeActivity.this, "KC không đủ", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void showStopDialog() {
        ...
        Dialog stopDialog = new Dialog(ChallengeActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
    ...
    private void showRetryDialog() {
        // Tạo dialog thử lại
        Dialog retryDialog = new Dialog(ChallengeActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        ...
        btnExitYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (rewardedAd != null) {
                    Activity activityContext = ChallengeActivity.this;
...
//                        showWaitingMessage();
                        disableAllButtons();
                        Toast.makeText(ChallengeActivity.this, "Xin vui lòng chờ đến lượt của bạn", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
                    Toast.makeText(ChallengeActivity.this, "Room is NULL", Toast.LENGTH_SHORT).show();
                }
            }
